...
def inference():
        try :
                ...
                holistic = mpp.solutions.holistic
                hands = mpp.solutions.hands
                holis = holistic.Holistic()
                drawing = mpp.solutions.drawing_utils
                ...
                while True:
                        ...
                        if time.time() > future:
                                ...
                                file= music_player.run_music_player(tex)
                ...
                print(f"Error occured at inference : {e}")